...
function updateConnectionStatus(status, peerId = null, timeoutReason = null) {
  ...
  switch (status) {
    case 'connecting':
      statusElement.innerHTML = '<span class="status-icon connecting">⏳</span> Connecting...';
      sendFileBtn.disabled = true;
      break;
    case 'connected':
      statusElement.innerHTML = '<span class="status-icon connected">✅</span> Connected';
      sendFileBtn.disabled = selectedFiles.length === 0;
      break;
    case 'disconnected':
      statusElement.innerHTML = '<span class="status-icon disconnected">❌</span> Disconnected';
      sendFileBtn.disabled = true;
      break;
    case 'connection-timeout':
      ...
      statusElement.innerHTML = '<span class="status-icon disconnected">⚠️</span> Connection Timeout';
      ...
      break;
    default:
      statusElement.innerHTML = '<span class="status-icon unknown">❓</span> Unknown';
      sendFileBtn.disabled = true;
  }
